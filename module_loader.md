...
This lightweight root file is generated from `canonicals/module_loader/`.
...
The authoritative body for this canonical is split across `canonicals/module_loader/`.
This root exists only as a small index and compatibility pointer for `module_loader.md`.
