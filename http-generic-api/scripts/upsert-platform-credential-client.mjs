...
const result = await upsertPlatformCredentialClientConfig({
  ...
  client_type: argValue("client-type") || "web",
  client_id: argValue("client-id"),
  client_secret_ref: argValue("client-secret-ref"),
  client_secret_hint: argValue("client-secret-hint"),
  client_secret_status: argValue("client-secret-status") || "enabled",
  authorized_javascript_origins: argValues("javascript-origin"),
  ...
  key_hint: argValue("key-hint"),
  allowed_apis: argValues("allowed-api"),
  api_restrictions: argValues("api-restriction"),
  application_restrictions: parseJsonArg("application-restrictions", {}),
  restrictions: parseJsonArg("restrictions", {}),
  bound_service_account_ref: argValue("bound-service-account-ref"),
  service_account_email: argValue("service-account-email"),
  service_account_unique_id: argValue("service-account-unique-id"),
