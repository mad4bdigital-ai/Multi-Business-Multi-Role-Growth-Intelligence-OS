...
assertDecodes("base64 env assignment decodes", `GITHUB_APP_PRIVATE_KEY=${b64Pem}`);
assertDecodes("exported base64 env assignment decodes", `export GITHUB_APP_PRIVATE_KEY="${b64Pem}"`);
