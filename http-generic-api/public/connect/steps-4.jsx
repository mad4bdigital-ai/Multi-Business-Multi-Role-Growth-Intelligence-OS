...
// ============================================================================
// PERSONAL PREFERENCES — segment-aware (step 05)
// ============================================================================
function PreferencesStep({ tenant, onSave, onBack }) {
  ...
  return (
    <div style={{ position: "relative" }}>
      <span className="label-eyebrow" style={{ color: accent }}>/connect · step 05 · personal preferences</span>
      <h1 style={{
      ...
      <div style={{ marginTop: 22, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span className="mono" style={{ fontSize: 11, color: "var(--muted)" }}>preferences saved to tenant_profile</span>
...
// ============================================================================
function BusinessProfileStep({ tenant, onSave, onBack }) {
  ...
  return (
    <div style={{ position: "relative" }}>
      <span className="label-eyebrow" style={{ color: accent }}>/connect · step 06 · business profile</span>
      <h1 style={{
        fontFamily: "var(--font-display)", fontWeight: 800,
        fontSize: 36, lineHeight: 1.06, letterSpacing: "-0.02em",
        margin: "8px 0 4px",
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
        ...
        <PrefSection title="CMS & analytics" hint="Where the public site lives. The connector reads/writes here.">
          <PrefRow label="CMS">
          ...
          <PrefRow label="API key / app password">
            <input className="input mono" type="password" value={cmsKey} onChange={(e) => setCmsKey(e.target.value)} placeholder="(stored as user_app_connection)"/>
          </PrefRow>
      ...
      <div style={{ marginTop: 22, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <button className="btn btn-quiet btn-sm" onClick={onBack}><Icon.arrow width={14} height={14} stroke="currentColor" style={{ transform: "rotate(180deg)" }}/> Back</button>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span className="mono" style={{ fontSize: 11, color: "var(--muted)" }}>POST /tenants/{tenant?.tenant_id}/profile</span>
          <button className="btn btn-primary" onClick={() => onSave({ bizType, industry, brandVoice, tagline, story, audience, locations, products, socials, cms, cmsUrl, analytics })}>
            Save & continue <Icon.arrow width={14} height={14} stroke="currentColor"/>
          </button>
        </div>
      </div>
...
Object.assign(window, { PreferencesStep, BusinessProfileStep, PrefSection, PrefRow, ChipGroup, SocialRow });
